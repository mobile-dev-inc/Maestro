 ...
 * This class contains pure functions that can be easily tested and reused.
 */
internal object CoordinateUtils {
     ...
     */
    fun calculateElementRelativePoint(element: UiElement, point: String): Point {
