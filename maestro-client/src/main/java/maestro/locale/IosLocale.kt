 ...
 * iOS has predefined locale codes, including special formats like zh-Hans.
 *
 * Use direct properties:
 * - IosLocale.EN_US.code
 * - IosLocale.EN_US.displayName
...
enum class IosLocale(override val code: String) : DeviceLocale {
  ...
  companion object {
     ...
     *
     * @throws LocaleValidationIosException if not found
     */
