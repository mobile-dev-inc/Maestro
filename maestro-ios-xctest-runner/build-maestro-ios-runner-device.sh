...
xcodebuild clean build-for-testing \
  ...
  CODE_SIGNING_ALLOWED=NO ARCHS="arm64" COMPILER_INDEX_STORE_ENABLE=NO

## Remove intermediates, output and copy runner in maestro-ios-driver
cp -r \
	./build/Products/Build/Products/Debug-iphoneos/maestro-driver-iosUITests-Runner.app \
	./maestro-ios-driver/src/main/resources/maestro-driver-iosUITests-Runner.app

cp -r \
	./build/Products/Build/Products/Debug-iphoneos/maestro-driver-ios.app \
