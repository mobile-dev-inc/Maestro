...
/**
 * Port of the native/compose/RN conformance fixture's FixtureEmitter — byte-identical logcat
 * contract so the harness's out-of-band oracle parser works unchanged across all frameworks.
